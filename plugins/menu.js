 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `🔖 ${pmenus} SEWA`, rowId: ".sewa", description: "Menampilkan list harga sewa 𝚁𝙲𝚃𝙸 BOT"},
	...
	rows: [
	    {title: `💬 ${pmenus} All`, rowId: ".? all", description: "Menampilkan Semua command 𝚁𝙲𝚃𝙸 BOT"},
  ...
  {title: `🎧 ${pmenus} Sound Menu`, rowId: ".soundmenu", description: "Kumpulan 120 Sound"},
	...
	{title: `ℹ️ ${pmenus} Info`, rowId: ".? info", description: "Info 𝚒𝚗𝚏𝚘 𝚁𝙲𝚃𝙸 BOT"},
...
//-------DOC TEMPLATE
    const message = {
            ...
            templateButtons: [
                {
                    urlButton: {
                        displayText: `grup Official 𝚁𝙲𝚃𝙸 𝙱𝙾𝚃 1`,
                        url: 'https://chat.whatsapp.com/GOdtUKyFn04ECxqqOrFf4G'
                    }
                },
                {
                    urlButton: {
